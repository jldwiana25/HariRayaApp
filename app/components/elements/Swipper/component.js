    ...
    return (
      ...
      >
        {lastScreen ? (
          ...
          //   type="raised-ripple"
          //   title={"mulai"}
          //   customContainer={styles.buttonOnBoarding}
          //   customText={styles.buttonText}
          //   onPress={onPress}
          // />
          <Text style={styles.skipButton} onPress={onPress}>
            Next
          </Text>
        ) : (
          // <Button
          ...
          //   onPress={() => this.swipe()}
          // />
          <Text style={styles.skipnone} onPress={() => this.swipe()} />
        )}
      </View>
    );
  };
  ...
  skipButton = () => {
    ...
    return (
      <View
        onPress={onPress}
        pointerEvents="box-none"
        style={[styles.buttonWrapper, styles.fullScreen, styles.skipWrap]}
      >
        {lastScreen ? (
          <Text style={styles.skip} onPress={onPress}>
            Next
          </Text>
        ) : (
          <Text style={styles.skipnone} onPress={() => this.swipe()} />
