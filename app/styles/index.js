...
export const COLOR_FONT_TERTIARY_GREY = "rgba(45, 58, 74, 0.4)";
...
export const FONT_TITLE_ONBOARDING = 25;
...
export const FONT_TITLE_ONBOARDINGS = {
  fontFamily: FONT_SECONDARY_SEMIBOLD,
  fontSize: FONT_TITLE_ONBOARDING,
};

export const FONT_OVERLINE_PAGE = {
  fontFamily: FONT_SECONDARY_REGULAR,
