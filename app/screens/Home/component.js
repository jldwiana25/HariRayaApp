  ...
  _getParams = async () => {
    try {
      ...
      const getData = await axios.get(
        "http://ec2-34-201-73-157.compute-1.amazonaws.com:9000/api/v1/users",
        {
          headers: {
        ...
        >
          <View style={styles.body}>
            ...
            <Text style={styles.content}>
              Mau belajar tentang apa Hari ini?
            </Text>
          </View>
                ...
                <Card transparent style={styles.card}>
                  ...
                  <CardItem style={styles.cardItem}>
                    <Body>
                      ...
                      <Text style={styles.page1}>25 Soal</Text>
                    </Body>
                  </CardItem>
                </Card>
              </TouchableOpacity>
