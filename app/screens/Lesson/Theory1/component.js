        ...
        <ScrollView>
          ...
          <View style={styles.content}>
            ...
            <Text style={styles.teory}>
              ...
              Adha yang jatuh pada 10 Dzulhijjah yang bertepatan dengan ibadah
              haji di Makkah Al-Mukarramah dan kerena itu disebut juga dengan
              Hari Raya Haji atau Hari Raya Qurban kerena disunnahkan berkurban
              bagi yang mampu. {"\n"}
            </Text>
            ...
            <Text style={styles.teory}>
              Menurut sebagian ulama tafsir, shalat yang dimaksud adalah shalat
              hari raya.
            </Text>
            <Text style={styles.teory}>Hadits Bukhari dan Muslim: {"\n"} </Text>
            <Text style={styles.arabian}>
              أُمِّ عَطِيَّةَ رَضِيَ اللَّهُ عَنْها قَالَتْ : أَمَرَنَا رَسُولُ
              اللَّهِ صَلَّى اللَّهُ عَلَيْهِ وَسَلَّمَ أَنْ نُخْرِجَهُنَّ فِي
              الْفِطْرِ وَالأَضْحَى الْعَوَاتِقَ وَالْحُيَّضَ وَذَوَاتِ
              الْخُدُورِ ، فَأَمَّا الْحُيَّضُ فَيَعْتَزِلْنَ الصَّلاةَ
              وَيَشْهَدْنَ الْخَيْرَ وَدَعْوَةَ الْمُسْلِمِينَ . قُلْتُ : يَا
              رَسُولَ اللَّهِ ، إِحْدَانَا لا يَكُونُ لَهَا جِلْبَابٌ
              {"\n"} . قَالَ : لِتُلْبِسْهَا أُخْتُهَا مِنْ جِلْبَابِهَا .
            </Text>
            <Text style={styles.teory}> Artinya:</Text>
            <Text style={styles.arti}>
              Ummu Atiyyah berkata: Rasulullah menyuruh kami perempuan untuk
              keluar di Idul Fitri dan Idul Adha. Baik wanita yang baru balig,
              wanit` sedang haid dan wanita perawan. Sementara orang yang haid
              dipisahkan dari (tempat) shalat. Agar mereka dapat menyaksikan
              kebaikan dan doa umat Islam." Saya berkata, ‘Wahai Rasulullah, ada
              di antara kami yang tidak mempunyai jilbab." Beliau mengatakan,
